...
/**
 * Created by yunfanchen on 27/3/2018.
 * Music for count game.
 */
public class SoundPlayer4Rabbit extends Service {
    ...
    public void onCreate() {
        ...
        try {
            ...
            mp = new MediaPlayer();
            mp = MediaPlayer.create(SoundPlayer4Rabbit.this, R.raw.rabbit);
            mp.prepare();
        } catch (IllegalStateException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
